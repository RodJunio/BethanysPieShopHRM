        ...
        internal static void RegisterEmployee(List<Employee> employees)
        {
            ...
            switch (employeeType)
            {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    employee = new Researche(firstName, lastName, email, birthDay, rate);
                    break;
                case "5":
                    ...
                    for (int i = 0; i < employeesAsString.Length; i++)
                    {
                        ...
                        switch (employeeType)
                        {
                            ...
                            case "3":
                                ...
                                break;
                            case "4":
                                employee = new Researche(firstName, lastName, email, birthDay, hourlyRate);
                                break;
                            case "5":
